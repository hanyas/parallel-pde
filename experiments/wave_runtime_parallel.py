...
from bayes_pde.solvers import sequential_solver, parallel_solver
...
if __name__ == "__main__":
    ...
    runtime_mean, runtime_median = \
        measure_runtime(dt_list, nb_iter=args.nb_iter, nb_runs=args.nb_runs, parallel=True)
    ...
    #
    # if args.parallel:
    #     df.to_csv("./results/wave_runtime_parallel.csv")
    # else:
    #     df.to_csv("./results/wave_runtime_sequential.csv")
